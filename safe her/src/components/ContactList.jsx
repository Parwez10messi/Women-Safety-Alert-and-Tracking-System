...
export default function ContactList({ contacts, onAddClick, onEditClick, onDeleteClick }) {
  ...
  return (
    <div className="glass-panel p-6 border border-safety-purple-100">
      
      {/* Widget Header */}
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-xl font-bold text-slate-805">Emergency Contacts</h2>
          <p className="text-xs text-slate-500 font-semibold">Your trusted circle who will receive SOS alerts</p>
        </div>
        <button
          onClick={onAddClick}
          className="p-2.5 rounded-xl bg-gradient-to-r from-safety-purple-500 to-safety-purple-700 hover:from-safety-purple-600 hover:to-safety-purple-800 text-white font-bold flex items-center justify-center space-x-1 transition shadow-md hover:shadow-red-500/10"
          title="Add Contact"
        >
