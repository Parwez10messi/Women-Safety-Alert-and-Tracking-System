  ...
  return (
    <div className="glass-panel p-6 border border-safety-purple-100/60 relative overflow-hidden">
      ...
      <h2 className="text-xl font-bold text-slate-805 flex items-center space-x-2 mb-2 relative z-10">
        <Phone className="h-5 w-5 text-safety-purple-600 animate-bounce-slow" />
      ...
      <div className="space-y-4 relative z-10">
        {helplines.map((item, idx) => (
          ...
          >
            ...
            <div className={`px-4 py-2 rounded-xl text-xs font-black tracking-wider ${item.btnBg} transition-all flex items-center space-x-1 shadow-sm`}>
